...
it('can get an attribute from a function', function (): void {
    $attribute = Attributes::onFunction('Tests\\TestSupport\\testFunction', MultiTargetAttribute::class);
...
it('returns null for a function without the attribute', function (): void {
    expect(Attributes::onFunction('Tests\\TestSupport\\testFunction', SimpleAttribute::class))->toBeNull();
});
...
it('can get the first attribute from a function without filtering', function (): void {
    $attribute = Attributes::onFunction('Tests\\TestSupport\\testFunction');
...
it('can get all attributes from a function', function (): void {
    $attributes = Attributes::getAllOnFunction('Tests\\TestSupport\\testFunction', MultiTargetAttribute::class);
...
it('can get all attributes from a function without filtering', function (): void {
    $attributes = Attributes::getAllOnFunction('Tests\\TestSupport\\testFunction');
...
it('can cache and clear reflection metadata', function (): void {
    Attributes::clearReflectionCaches();

    expect(Attributes::reflectionCacheCount())->toBe(['classes' => 0, 'functions' => 0]);

    Attributes::get(TestClass::class, SimpleAttribute::class);
    Attributes::onFunction('Tests\\TestSupport\\testFunction', MultiTargetAttribute::class);

    expect(Attributes::reflectionCacheCount())->toBe(['classes' => 1, 'functions' => 1]);
